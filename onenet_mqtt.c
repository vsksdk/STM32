...
static void onenet_cmd_rsp_cb(uint8_t *recv_data, size_t recv_size, uint8_t **resp_data, size_t *resp_size)
{
   ...
   // LOG_D("recv data is %.*s", recv_size, recv_data);
    ...
    else if (rt_strncmp((const char *)recv_data, "ledoff", 6) == 0)
    {
        ...
        LOG_D("led is off");
		    ...
		    else if (rt_strncmp((const char *)recv_data, "beep", 4) == 0)
    {
        /* 蜂鸣器响 */
        ...
        rt_pin_write(PIN_BEEP, PIN_LOW);
				 ...
				 else if (rt_strncmp((const char *)recv_data, "open", 4) == 0)
    {
        ...
        rt_pin_write(PIN_MOTOR_B, PIN_LOW);
				 ...
				 else if (rt_strncmp((const char *)recv_data, "close", 5) == 0)
    {
        rt_pin_write(PIN_MOTOR_A, PIN_LOW);
        rt_pin_write(PIN_MOTOR_B, PIN_HIGH);
			  rt_thread_mdelay(500);  // 延时500ms
        ...
        rt_pin_write(PIN_MOTOR_B, PIN_LOW);
				 ...
				 else if (rt_strncmp((const char *)recv_data, "dw", 2) == 0)
    {
			  lcd_clear(WHITE); 
		    lcd_show_string(0, 10, 32, "Access control system");
		    lcd_draw_line(0, 10+32+32+10, 240, 10+32+32+10);
			  lcd_show_string(10, 10+32+32+10+10, 32, "welcome ");
			  lcd_show_string(10, 10+32+32+10+10+32, 32, "owner dw");
			  rt_pin_write(PIN_BEEP, PIN_HIGH);
        rt_pin_write(PIN_MOTOR_A, PIN_LOW);
        rt_pin_write(PIN_MOTOR_B, PIN_HIGH);
			  rt_thread_mdelay(500);  // 延时500ms
        ...
        rt_pin_write(PIN_MOTOR_B, PIN_LOW);
				...
				else if (rt_strncmp((const char *)recv_data, "ysh", 3) == 0)
    {
			  lcd_clear(WHITE); 
		    lcd_show_string(0, 10, 32, "Access control system");
		    lcd_draw_line(0, 10+32+32+10, 240, 10+32+32+10);
			  lcd_show_string(10, 10+32+32+10+10, 32, "welcome ");
			  lcd_show_string(10, 10+32+32+10+10+32, 32, "owner ysh");
			  rt_pin_write(PIN_BEEP, PIN_HIGH);
        rt_pin_write(PIN_MOTOR_A, PIN_LOW);
        rt_pin_write(PIN_MOTOR_B, PIN_HIGH);
			  rt_thread_mdelay(500);  // 延时500ms
        ...
        rt_pin_write(PIN_MOTOR_B, PIN_LOW);
				...
				else if (rt_strncmp((const char *)recv_data, "qcl", 3) == 0)
    {
			  lcd_clear(WHITE); 
		    lcd_show_string(0, 10, 32, "Access control system");
		    lcd_draw_line(0, 10+32+32+10, 240, 10+32+32+10);
        lcd_show_string(10, 10+32+32+10+10, 32, "welcome ");
			  lcd_show_string(10, 10+32+32+10+10+32, 32, "owner qcl");			
			  rt_pin_write(PIN_BEEP, PIN_HIGH);
        rt_pin_write(PIN_MOTOR_A, PIN_LOW);
        rt_pin_write(PIN_MOTOR_B, PIN_HIGH);
			  rt_thread_mdelay(500);  // 延时500ms
        ...
        rt_pin_write(PIN_MOTOR_B, PIN_LOW);
		  	...
		  	else if (rt_strncmp((const char *)recv_data, "lly", 3) == 0)
    {
			  lcd_clear(WHITE); 
		    lcd_show_string(0, 10, 32, "Access control system");
		    lcd_draw_line(0, 10+32+32+10, 240, 10+32+32+10);
			  lcd_show_string(10, 10+32+32+10+10, 32, "welcome ");
			  lcd_show_string(10, 10+32+32+10+10+32, 32, "guardian lly");
			  rt_pin_write(PIN_BEEP, PIN_HIGH);
        rt_pin_write(PIN_MOTOR_A, PIN_LOW);
        rt_pin_write(PIN_MOTOR_B, PIN_HIGH);
			  rt_thread_mdelay(500);  // 延时500ms
        ...
        rt_pin_write(PIN_MOTOR_B, PIN_LOW);
				...
				else if (rt_strncmp((const char *)recv_data, "bj", 2) == 0)
    {
			 lcd_clear(WHITE); 
		    lcd_show_string(0, 10, 32, "Access control system");
		    lcd_draw_line(0, 10+32+32+10, 240, 10+32+32+10);
			  lcd_show_string(10, 69+16+24, 32, "baojing");  
			 for(i=0;i<3;i++)
			  {
			  rt_pin_write(PIN_BEEP, PIN_HIGH);
			  rt_thread_mdelay(500);  // 延时500ms
    ...
    *resp_data = (uint8_t *)ONENET_MALLOC(strlen(res_buf) + 1);
    ...
    //strncpy((char *)resp_data, res_buf, strlen(res_buf));
		strncpy((char *)*resp_data, res_buf, strlen(res_buf) + 1);
